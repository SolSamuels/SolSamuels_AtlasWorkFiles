...
%  negative ions, SR Atlas, 10/5/2020.  Further modified to allow for
%  linear beta function (Model 6), SRA, 10/15/20.


function den_fn = density_model_7_eval_fn(A0, B0, Z, alpha, beta, C0, mm, gamma, D0, eta, bb, E0, delta, pp, qq, tt, r, rCut)
